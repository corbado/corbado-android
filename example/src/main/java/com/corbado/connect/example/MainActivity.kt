...
import com.corbado.connect.example.ui.home.HomeScreen
...
class MainActivity : ComponentActivity() {
    ...
    fun setInvTokens(
        allowedByGradualRollout: Boolean,
        allowInAppAppendInstant: Boolean,
        allowInAppAppendButton: Boolean,
    ) {
        ...
        } else if (allowInAppAppendInstant) {
            corbado.setInvitationToken("inv-token-correct-a")
        } else if (allowInAppAppendButton) {
            corbado.setInvitationToken("inv-token-correct-b")
        } else {
